...
<html lang="en">
  ...
  <body>
    ...
    <div class="single-product-area">
     ...
     <h3> upload product image</h3>
         ...
         <form action="productimageupcontrol.jsp" method="post" enctype="multipart/form-data">
  ...
  <%
            ...
            String productId=Integer.toString(n);
       ...
       Object res=st.executeUpdate("insert into products(productId,productName,type,details,price)values('"+productId+"','"+name+"','"+type+"','"+details+"','"+price+"')");
